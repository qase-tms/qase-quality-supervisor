...
_Generated by Qase Quality Supervisor · quality-report_
...
One attribution line per document, top and bottom. The skills above each carry
their own when run on their own; folded into this report they do not — a
consolidated report signed four times reads as a stitching artefact, not as
provenance. Strip theirs, keep this command's.
